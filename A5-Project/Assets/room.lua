...
earth_mat = gr.image_material('earth.png', {0, 0, 0}, 100, false)
stars_mat = gr.image_material('stars.png', {0, 0, 0}, 100, true)
wood_mat = gr.image_material('wood.png', {0.3, 0.3, 0.3}, 100, false)
