...
glass = gr.clear_material({0.0, 0.0, 0.0}, {0.95, 0.95, 0.95}, 25, 1, 1.0)			--enable optics
glass2 = gr.mirror_material({0.0, 0.0, 0.0}, {0.95, 0.95, 0.95}, 25, 1)
...
opticGlass = gr.nh_sphere('opticGlass', {0, 0, 500}, 50)
scene_root:add_child(opticGlass)
opticGlass:set_material(glass2)

-- A small stellated dodecahedron.

steldodec = gr.mesh( 'dodec', 'Assets/smstdodeca.obj' )
steldodec:set_material(mat3)
steldodec:translate(150, -100, -300)
