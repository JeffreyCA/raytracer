...
mirror_mat = gr.mirror_material({0.0, 0.0, 0.0}, {0.8, 0.8, 0.8}, 1000, 0)
mirror2_mat = gr.mirror_material({0.0, 0.0, 0.0}, {0.9, 0.9, 0.9}, 1000, 6)
...
mirror_sphere:scale(1.2, 1.2, 1.2)
mirror_sphere:translate(-2.8, -3.8, -14.5)
mirror_sphere:set_material(mirror_mat)

glossy_sphere = gr.sphere('glossy_sphere')
scene_root:add_child(glossy_sphere)
glossy_sphere:scale(1.2, 1.2, 1.2)
glossy_sphere:translate(0, -3.8, -14.5)
glossy_sphere:set_material(mirror2_mat)
...
gr.render(scene_root, 'reflection.png', 500, 500,
	  {0.0, -2.0, 0.0}, {0, -3, -box_length / 2.0}, {0, 1, 0}, 40,
